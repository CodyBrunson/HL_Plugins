...
class ChatEnhancer extends Plugin {
    ...
    private friendsList = new Set<String>();
    private showNonFriendPM: string | boolean | number = true;
    ...
    constructor() {
        ...
        this.settings.hideNonFriends = {
            text: 'Hide Non-Friend PM',
            type: SettingsTypes.checkbox,
            value: false,
            callback: () => this.toggleShowNonFriendPM()
        }
    }
    ...
    private toggleShowNonFriendPM(): void {
        this.showNonFriendPM = this.settings.showNonFriendPM.value;
    }
    ...
    private initializePlugin(): void {
        ...
        this.friendsList = this.gameHooks.ChatManager._chatManager._friends
    ...
    private processNewMessages(container: HTMLElement): void {
        ...
        messages.forEach(msg => {
            ...
            if(!this.showNonFriendPM && this.friendsList.has(playerName.toLowerCase())) {
                msgEl.style.display = 'none';
                this.log("Non-Friend tried to message you: " + playerName);
            }
